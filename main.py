...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='TrainingImages', help='[ dataset / TrainingImages]')
    ...
    parser.add_argument('--print_freq', type=int, default=1, help='The number of image_print_freqy')
